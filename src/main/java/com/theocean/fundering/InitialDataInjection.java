...
//   @Bean
//   public CommandLineRunner initHeart(HeartRepository heartRepository, JdbcTemplate jdbcTemplate) {
//     return args -> {
//       if (heartRepository.count() == 0) {
//         String query1 = "INSERT INTO heart (member_id, post_id) VALUES (1, 1)";
//         String query2 = "INSERT INTO heart (member_id, post_id) VALUES (1, 2)";
//         String query3 = "INSERT INTO heart (member_id, post_id) VALUES (2, 2)";
